...
/* ------------------------------------------------------------------ */
/* Generic battery -> power_supply helper (from openrazer PR #2868)   */
/* get_property serves a cache only (never blocks); poll devices set  */
/* refresh_cb (runs on a worker with a QUIET query), push devices     */
/* leave it NULL and call razer_power_supply_set() from their push    */
